...
var _default = {
  ...
  setOptions: function setOptions(_ref, options) {
    ...
    clientStore.update(function () {
      var updatedOptions = (0, _objectSpread3.default)({}, _defaultState.default.shortcutOptions, (0, _lodash.default)(options, Object.keys(_defaultState.default.shortcutOptions)));
